...
import { Shield, LogOut, LogIn, UserPlus, AlertCircle, Menu, X, User as UserIcon } from 'lucide-react';
              ...
              {user ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl hover:bg-gray-800/60 border border-transparent hover:border-gray-700 transition-all text-left"
                  ...
                  >
                    ...
                    <div className="hidden sm:block">
                      ...
                      <span className="text-[10px] text-indigo-400 capitalize font-medium">{user.role.replace('_', ' ')}</span>
                    </div>
                  </button>
              ...
              {user ? (
                <div className="flex items-center justify-between w-full">
                  ...
                  >
                    ...
                    {user.name} <span className="text-[10px] text-gray-400">({user.role})</span>
                  </button>
                  <button
                    onClick={handleLogout}
